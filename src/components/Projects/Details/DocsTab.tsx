...
interface DocsTabProps {
  ...
  canEdit: boolean; // <--- Propriedade essencial para controle de acesso
}

export const DocsTab: React.FC<DocsTabProps> = ({ project, onSaveDocs, canEdit }) => {
  ...
  return (
    <div className="h-full flex flex-col">
      <div className="flex justify-between items-center mb-6 bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
        ...
        {/* PROTEÇÃO: Botões só aparecem se puder editar */}
        {canEdit && (
          ...
          <div className="flex-1 p-8 overflow-y-auto prose prose-slate max-w-none">
            {docsContent ? (
                ...
                <div className="flex flex-col items-center justify-center h-full text-slate-400 gap-4">
                    ...
                    {/* Link de ação rápida também protegido */}
                    {canEdit && (
